...
export const tahapKpr: Tahap[] = [
  {
    ...
    fakta: { nilai: "30–40%", label: "Batas cicilan sehat dari penghasilan", status: "indikatif" },
    penjelasan: [
  ...
  },
  {
    ...
    fakta: { nilai: "3–5 unit", label: "Survei sebelum membayar booking fee", status: "estimasi" },
    penjelasan: [
  ...
  },
  {
    ...
    fakta: { nilai: "±Rp250rb–1jt", label: "Kisaran booking fee unit", status: "indikatif" },
    penjelasan: [
  ...
  },
  {
    ...
    fakta: { nilai: "1–3 hari", label: "Kelengkapan berkas pengajuan", status: "estimasi" },
    penjelasan: [
  ...
  },
  {
    ...
    fakta: { nilai: "1–3 minggu", label: "Analisis kredit + appraisal", status: "estimasi" },
    penjelasan: [
  ...
  },
  {
    ...
    fakta: { nilai: "1–4 minggu", label: "Proses akad sampai kunci", status: "estimasi" },
    penjelasan: [
  ...
  },
  {
    ...
    fakta: { nilai: "1–3%", label: "Dana perawatan rumah tiap tahun", status: "indikatif" },
    penjelasan: [
