...
"Warga Negara Indonesia, usia sesuai aturan skema (perlu dicek ulang ke bank penyalur), belum pernah memiliki rumah, belum pernah menerima subsidi perumahan, dan penghasilan di bawah batas MBR. Batasnya berbeda per zona wilayah: Rp8,5–14 juta/bulan (belum kawin–kawin) sesuai aturan FLPP terbaru (Permen PKP No. 5/2025 jo. No. 11/2025 jo. No. 1 Tahun 2026). Konfirmasi batas zonamu ke BP Tapera atau bank penyalur.",
  ...
  },
  {
    ...
    jawaban:
      "Tapera Mobile adalah aplikasi resmi BP Tapera untuk mengajukan dan memantau status pembiayaan rumah subsidi (FLPP). Portal data pengembang dan stok rumah subsidi juga dikelola BP Tapera — kalau pengembang mengklaim proyeknya subsidi, cek dulu di sana.",
  },
  {
    pertanyaan: "Siapa yang mengelola program KPR subsidi (FLPP) sekarang?",
    jawaban:
      "Sejak 2025 pengelolaan FLPP dipegang BP Tapera, dengan payung kebijakan Kementerian Perumahan dan Kawasan Permukiman (PKP). Jadi sumber informasi terkini adalah situs BP Tapera / aplikasi Tapera Mobile, bukan lagi kanal lama Kementerian PUPR.",
  },
  {
