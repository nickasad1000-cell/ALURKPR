...
export const panduanArtikel: PanduanArtikel[] = [
  {
    ...
    isi: [
      ...
      "Sasaran program ini rumah tangga MBR: umumnya penghasilan pokok di bawah ketentuan yang berlaku (untuk rumah tapak ± Rp8 juta/bulan sesuai aturan terbaru), usia minimal 21 tahun atau sudah menikah, belum pernah punya rumah, dan belum pernah menerima subsidi perumahan pemerintah.",
      "Harga unit juga dibatasi plafon per zona: bervariasi antara Rp166 hingga Rp240 juta untuk rumah tapak tergantung wilayah. Rumah yang bisa dibeli harus termasuk unit perumahan terdaftar penerima FLPP.",
      "Alur pengajuan: pilih pengembang mitra FLPP → booking unit → pengembang mengajukan data ke sistem verifikasi Kementerian PUPR → bank penyalur memproses kredit → akad → serah terima. Verifikasi MBR adalah pintu masuknya, jadi pastikan datamu bersih dan konsisten.",
      ...
      "Angka bunga, plafon, dan batas penghasilan bisa berubah mengikuti kebijakan. Selalu cek informasi resmi Kementerian PUPR dan bank penyalur sebelum mengajukan.",
    ],
  },
  {
    slug: "kpr-komersial",
  ...
  },
  {
    ...
    isi: [
      ...
      "Pitfall paling umum: memilih tenor paling pendek supaya 'cepat lunas' tanpa sadar angsuran menjadi tidak realistis, atau memilih tenor terpanjang karena angsurannya kecil tanpa sadar total bunga membengkak puluhan persen.",
      ...
      "Ingat, simulasi memakai skema anuitas murni. Bank bisa menambahkan biaya sistematis (asuransi, administrasi) dan beberapa bancassurance sekali bayar — tambahkan biaya tersebut agar angka lebih akurat.",
    ],
  },
  {
  ...
  },
  {
    ...
    isi: [
      ...
      "Di area 6–12 bulan sebelum pengajuan: jaga riwayat rekening tetap sehat (hindari saldo 'tipis' & sering telat), hindari ngejam BI Checking dengan aplikasi baru berlebihan, dan stabilkan pekerjaan.",
      "Siapkan juga 'pos biaya awal' terpisah dari DP: BPHTB, notaris, provisi, asuransi. Mengambil semuanya dari DP adalah resep jalan ditengah ambyar.",
