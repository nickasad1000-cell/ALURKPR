...
export const panduanArtikel: PanduanArtikel[] = [
  {
    ...
    isi: [
"FLPP (Fasilitas Likuiditas Pembiayaan Perumahan) adalah skema subsidi pemerintah berupa dana murah yang diteruskan bank penyalur untuk KPR MBR. Praktisnya kamu menikmati bunga rendah — saat ini sekitar 5% flat — dengan DP ringan, dan tenor hingga 40 tahun.",
      "Sasaran program ini rumah tangga MBR: penghasilan di bawah batas yang berlaku — untuk rumah tapak, Rp8,5–14 juta/bulan tergantung zona wilayah dan status pernikahan (Permen PKP No. 5/2025 jo. No. 11/2025 jo. No. 1 Tahun 2026). Syarat lain: usia sesuai aturan skema (perlu dicek ulang ke bank penyalur), belum pernah punya rumah, dan belum pernah menerima subsidi perumahan pemerintah.",
  ...
  },
  {
    ...
    isi: [
      "KPR subsidi (FLPP) menang telak di biaya: bunga sekitar 5% flat, DP ringan, tenor hingga 40 tahun. Trade-off-nya: hanya untuk MBR, unit harus rumah pertama, harga dibatasi plafon zona, dan lokasi terbatas pada proyek terdaftar.",
