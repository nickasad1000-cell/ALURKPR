...
export const metadata: Metadata = {
  ...
  description:
    "AlurKPR adalah proyek literasi keuangan perumahan: membimbing calon pemilik rumah pertama memahami alur KPR subsidi dan komersial secara terbuka dan jelas.",
